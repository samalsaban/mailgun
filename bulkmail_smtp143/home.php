            ...
            <div class="col-sm-6">
                  ...
                  <button class="btn btn-success"> <i class="fa fa-camera fa-lg pr-2" aria-hidden="true">  <input type="button" value=" Preview " onClick="displayHTML()" class="btn btn-success btn-rounded"></i></button>
                     ...
                     <div>
                      ...
                      <textarea  name="mszc" id="mszc" cols="75" rows="20"></textarea>
                      </div></div>                       
              </div>
              <div class="col-sm-6">
                <div class="card h-85">
...
<dt class="col-6"><strong>Token</strong>&nbsp;&nbsp;<input type="text" name="token" id="token" size="20">
    </dt><dd class="col-6">              <strong>CAP</strong>&nbsp;&nbsp;<input type="text" name="limit" id="limit" size="20">
</dd> 
<dt> 
			 ...
			 <div name="sendAuto" id="sendAuto" style="display: none;" class="text-center">
				 <table cellpadding="10" cellspacing="0" width="500" align="center" border="0">
						 <tr align="center">
						   <td width="20%"></td>
						   <td align="center" style="padding-left:6px;">
						   <button name="setautorun" id="setautorun" style="width: 160px; height: 35px;" class="btn btn-primary button1"> <i class="fa fa-envelope fa-lg"></i>Script </button>
						   </td>						   
						 </tr>
				 </table>
			 </div>	
              <div class="col-sm">
                  ...
                  <dt> <p>
                  <strong>Run Mode</strong>&nbsp;&nbsp;&nbsp<input name="runmode" id="runmode" type="radio" value="normal" class="rad" checked="checked" onchange="hideParams()";>&nbsp;Default&nbsp;
